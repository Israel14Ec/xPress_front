        ...
        >
          <div class="pt-3">
            ...
            <div class="text-center">
              <IconRoute
                v-for="option in optionRoute"
                  :key="option.name"
                  :to="option.nameRoute"
                  :parent-route-name="'DepartmentLayout'"
...
onMounted(() => {
  webSocket.startListeningJob() //Escucha por el Websocket
  webSocket.startListenReportWorkComplete() //Escucha por el websocket de trabajo completado
  notification.getUnRead() //Trae las notificaciones no Leidas
  notification.getRead() //Llama a las notificaciones leidas
